...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="75%" valign="top" align="left"> 
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr> 
          <td valign="middle" align="left">当前为第  ${pager.firstRow+1} 到  ${pager.pageRows*(pager.currentPage)} 条记录，共 ${pager.totalRows}条商品信息 </td>
        </tr>
      </table>
      ...
      <c:forEach items="${productList}" var="p">
        <tr> 
          ...
          <a href="product.asp?"><img src="images/product/${p.smallImg}" border="0"/></a>
          </td>
          <td width="80%">
          <a href="product.asp?" class="productName">${p.name}</a>
        ...
        <tr> 
          <td width="80%"> 
            ...
            <c:if test="${p.price!=0}">
            原价：<span class="hotPrice">${p.price}</span>元　现价： 
            </c:if>
            <!-- 是否显示原价 -->
            <c:if test="${p.price==0}">
          ...
          <td align="center"> 
            <table border="0" width="90%">
              <tr> 
                ...
                <td width="15%" align="right"> 
                  <!--是否显示最末页 -->
                  <a href="subcategory.jsp?id=${subCategory.id}&currentPage=${pager.pageCount+1}" class="navi">最末页</a> 
                  <!--是否显示最末页 -->
                </td>
                </c:if>
              </tr>
